...
import IconMaterialLibrary from 'react-native-vector-icons/MaterialIcons';
import IconMaterialCommunityLibrary from 'react-native-vector-icons/MaterialCommunityIcons';
import IconIonLibrary from 'react-native-vector-icons/Ionicons';
import IconFontAwesomeLibrary from 'react-native-vector-icons/FontAwesome';
...
export declare type IconMaterialProps = {
  name:
    | '360'
    | '10k'
    | '10mp'
...
class IconMaterial extends Component<IconProps & IconMaterialProps> {
  ...
  render() {
    const {name, size, color} = this.props;
    return <IconMaterialLibrary name={name} size={size} color={color} />;
  }
}

export declare type IconIonProps = {
  name:
    | 'add'
    | 'add-circle'
    | 'add-circle-outline'
...
export declare type IconMaterialCommunityProps = {
  name:
    | 'ab-testing'
    | 'abacus'
    | 'abjad-arabic'
...
> {
  ...
  render() {
    const {name, size, color} = this.props;
    return (
      <IconMaterialCommunityLibrary name={name} size={size} color={color} />
    );
  }
}

export declare type IconFontAwesomeProps = {
  name:
    | 'glass'
    | 'music'
    | 'search'
...
class IconFontAwesome extends Component<IconProps & IconFontAwesomeProps> {
  shouldComponentUpdate(nProps: IconProps & IconFontAwesomeProps) {
    const {name, size, color} = this.props;
    return (
      name !== nProps.name || size !== nProps.size || color !== nProps.color
    );
  ...
  render() {
    const {name, size, color} = this.props;
    return <IconFontAwesomeLibrary name={name} size={size} color={color} />;
  }
}

export {IconMaterial, IconIon, IconMaterialCommunity, IconFontAwesome};
